...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BbW6GD4-.js
var router_BbW6GD4__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DCxFkCiC.css";
var APP_NAME = "InventarisKu";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Manajemen inventaris aset kantor — pantau, catat, dan cetak daftar aset."
			},
			{
				name: "theme-color",
				content: "#4F46E5"
...
var $$splitComponentImporter = () => import("./routes-C3FSXaJ2.mjs");
...
//#endregion
export { getRouter, router_BbW6GD4__exports as t };
